...
func (producer *Producer) cleanup() (err error) {
	...
	producer.logger.Info("[Producer.cleanup] context canceled, about to cleanup resources", "cause", context.Cause(producer.context), "id", producer.id, "writeCount", producer.writeCount)
